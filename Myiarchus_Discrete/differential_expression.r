...
system("rm combined_output_Myiarchus.csv")
system("rm *Volcano.pdf")
system("rm ATFL_Specific_PCA_All_Tissues.pdf")
system("rm Summary_Plot.pdf")
system("rm Myiarchus_Figures.pdf")
...
metadata <- subset(metadata, metadata$Species == "Myiarchus cinerascens")
...
pdf("Myiarchus_Figures.pdf", width = 8.5, height = 11)
...
ggsave("ATFL_Brain_Volcano.pdf", brain_volcano_plot_fig, width = 6, height = 4, units = "in")

heart_volcano_plot_fig <- heart_volcano_plot + ggtitle(NULL)
ggsave("ATFL_Heart_Volcano.pdf", heart_volcano_plot_fig, width = 6, height = 4, units = "in")

liver_volcano_plot_fig <- liver_volcano_plot + ggtitle(NULL)
ggsave("ATFL_Liver_Volcano.pdf", liver_volcano_plot_fig, width = 6, height = 4, units = "in")

muscle_volcano_plot_fig <- muscle_volcano_plot + ggtitle(NULL)
ggsave("ATFL_Muscle_Volcano.pdf", muscle_volcano_plot_fig, width = 6, height = 4, units = "in")

kidney_volcano_plot_fig <- kidney_volcano_plot + ggtitle(NULL)
ggsave("ATFL_Kidney_Volcano.pdf", kidney_volcano_plot_fig, width = 6, height = 4, units = "in")
